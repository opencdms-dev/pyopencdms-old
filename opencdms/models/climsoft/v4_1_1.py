...
t_featuregeographicalposition = Table(
    'featuregeographicalposition', metadata,
    Column('belongsTo', ForeignKey('synopfeature.abbreviation'), nullable=False),
    Column('observedOn', String(50)),
    Column('latitude', Float(11, True)),
    Column('longitude', Float(11, True)),
...
t_observationfinal = Table(
    'observationfinal', metadata,
    Column('recordedFrom', ForeignKey('station.stationId'), nullable=False, index=True),
    Column('describedBy', ForeignKey('obselement.elementId'), index=True),
    Column('obsDatetime', DateTime),
    Column('obsLevel', String(255), server_default=text("'surface'")),
    Column('obsValue', DECIMAL(8, 2)),
    Column('flag', String(255), server_default=text("'N'")),
    Column('period', Integer),
    Column('qcStatus', Integer, server_default=text("'0'")),
    Column('qcTypeLog', Text),
    Column('acquisitionType', Integer, server_default=text("'0'")),
    Column('dataForm', String(255)),
    Column('capturedBy', String(255)),
    Column('mark', TINYINT),
    Column('temperatureUnits', String(255)),
    Column('precipitationUnits', String(255)),
    Column('cloudHeightUnits', String(255)),
    Column('visUnits', String(255)),
    Column('dataSourceTimeZone', Integer, server_default=text("'0'")),
    Index('obsFinalIdentification', 'recordedFrom', 'describedBy', 'obsDatetime', unique=True)
)


t_observationinitial = Table(
    'observationinitial', metadata,
    Column('recordedFrom', ForeignKey('station.stationId'), nullable=False, index=True),
    Column('describedBy', ForeignKey('obselement.elementId'), index=True),
    Column('obsDatetime', DateTime),
    Column('obsLevel', String(255)),
    Column('obsValue', String(255)),
...
t_paperarchive = Table(
    'paperarchive', metadata,
    Column('belongsTo', ForeignKey('station.stationId')),
    Column('formDatetime', DateTime),
    Column('image', String(255)),
    Column('classifiedInto', ForeignKey('paperarchivedefinition.formId'), index=True),
...
t_stationlocationhistory = Table(
    'stationlocationhistory', metadata,
    Column('belongsTo', ForeignKey('station.stationId')),
    Column('stationType', String(255)),
    Column('geoLocationMethod', String(255)),
    Column('geoLocationAccuracy', Float(11)),
    Column('openingDatetime', String(50)),
    Column('closingDatetime', String(50)),
    Column('latitude', Float(11, True)),
    Column('longitude', Float(11, True)),
    Column('elevation', BigInteger),
    Column('authority', String(255)),
    Column('adminRegion', String(255)),
    Column('drainageBasin', String(255)),
    Index('history', 'belongsTo', 'openingDatetime', unique=True)
)


t_stationqualifier = Table(
    'stationqualifier', metadata,
    Column('qualifier', String(255)),
    Column('qualifierBeginDate', String(50)),
    Column('qualifierEndDate', String(50)),
    Column('stationTimeZone', Integer, server_default=text("'0'")),
    Column('stationNetworkType', String(255)),
    Column('belongsTo', ForeignKey('station.stationId'), index=True),
...
t_instrumentinspection = Table(
    'instrumentinspection', metadata,
    Column('performedOn', ForeignKey('instrument.instrumentId')),
    Column('inspectionDatetime', String(50)),
    Column('performedBy', String(255)),
    Column('status', String(255)),
    Column('remarks', String(255)),
    Column('performedAt', ForeignKey('station.stationId'), index=True),
    Index('inspection', 'performedOn', 'inspectionDatetime', unique=True)
)


t_observationschedule = Table(
    'observationschedule', metadata,
    Column('classifiedInto', ForeignKey('obsscheduleclass.scheduleClass')),
    Column('startTime', String(50)),
    Column('endTime', String(50)),
    Column('interval', String(255)),
    Column('additionalObsTime', String(255)),
    Index('scheduleIdentification', 'classifiedInto', 'startTime', 'endTime', unique=True)
)


t_physicalfeature = Table(
    'physicalfeature', metadata,
    Column('associatedWith', ForeignKey('station.stationId'), nullable=False, index=True),
    Column('beginDate', String(50)),
    Column('endDate', String(50)),
    Column('image', String(255)),
    Column('description', String(255)),
    Column('classifiedInto', ForeignKey('physicalfeatureclass.featureClass'), index=True),
    Index('featureIdentification', 'associatedWith', 'beginDate', 'classifiedInto', 'description', unique=True)
)


t_stationelement = Table(
    'stationelement', metadata,
    Column('recordedFrom', ForeignKey('station.stationId'), index=True),
    Column('describedBy', ForeignKey('obselement.elementId'), index=True),
    Column('recordedWith', ForeignKey('instrument.instrumentId'), index=True),
    Column('instrumentcode', String(6)),
    Column('scheduledFor', ForeignKey('obsscheduleclass.scheduleClass'), index=True),
    Column('height', Float(6)),
    Column('beginDate', String(50)),
    Column('endDate', String(50)),
...
t_faultresolution = Table(
    'faultresolution', metadata,
    Column('resolvedDatetime', String(50)),
    Column('resolvedBy', String(255)),
    Column('associatedWith', ForeignKey('instrumentfaultreport.reportId'), index=True),
    Column('remarks', String(255)),
