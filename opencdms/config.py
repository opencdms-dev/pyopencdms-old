...
class OpenCDMSConfig:
    ...
    MIDAS_PG_DB_HOST = os.getenv("MIDAS_PG_DB_HOST", "127.0.0.1")
    MIDAS_PG_DB_PORT = os.getenv("MIDAS_PG_DB_PORT", 5432)
    MIDAS_PG_DB_USER = os.getenv("MIDAS_PG_DB_USER", "postgres")
    MIDAS_PG_DB_PASS = os.getenv("MIDAS_PG_DB_PASSWORD", "password")
